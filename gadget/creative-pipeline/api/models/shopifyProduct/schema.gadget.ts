...
// This file describes the schema for the "shopifyProduct" model, go to https://creative-pipeline.gadget.app/edit to view/edit your model in Gadget
  ...
  fields: {
    campaignProducts: {
      ...
      children: {
        ...
        belongsToField: "shopifyProduct",
      },
      storageKey: "mUwbUf4I1uzU::Sn-OCtE2ArYh",
    },
  },
  shopify: {
    fields: {
